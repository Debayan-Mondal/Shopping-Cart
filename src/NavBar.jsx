...
export default function NavBar({info}) {
    ...
    return(
        <div className="z-10 sticky top-0 bg-[#d6e3ff87] bg-gradient-to-b from-white to-[#d6e3ff87] backdrop-blur-2xl flex shadow-2xl h-20 w-[100vw] justify-between items-center pl-[30px] pr-[30px]">
            <Link to="/">
